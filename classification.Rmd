...
Then whenever an update is performed,
...
where $t$ is the number of updates. The first inequality follows from the fact that $\mathbf{w}_*^TX_ty_t$ is at least as big as the margin.
